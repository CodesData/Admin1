<%@ Page Title="Wiki2" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Wiki2.aspx.cs" Inherits="Admin1.Wiki2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Wiki2</li>
        </ol>
    </nav>
    <!-- Content -->
    <section id="">
        ...
        <nav aria-label="pagination">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item">
                    <a class="page-link" href="Wiki1.aspx"><span aria-hidden="true">&raquo;</span></a>
                </li>
            </ul>
        </nav>
    </section>
